...
class FindAPetForeignBreedList extends StatefulWidget {
  final List<Breed> breedList;

  FindAPetForeignBreedList({this.breedList});
  @override
  _FindAPetForeignBreedListState createState() =>
      _FindAPetForeignBreedListState();
}

class _FindAPetForeignBreedListState extends State<FindAPetForeignBreedList> {
  @override
